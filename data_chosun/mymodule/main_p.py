...
from action_chosun import game_check, all_confirms, game_out_check, game_out_check_after
...
class MyApp(QDialog):
    ...
    def initUI(self):
        ...
        # 풀버젼
        # pyinstaller --hidden-import PyQt5 --hidden-import pyserial --hidden-import requests --hidden-import chardet --add-data="C:\\my_games\\chosun\\data_chosun;./data_chosun" --add-data="C:\\my_games\\chosun\\mysettings;./mysettings" --name chosun -i="chosun_start.ico" --add-data="chosun_start.ico;./" --icon="chosun_start.ico" --paths "C:\Users\1_S_3\AppData\Local\Programs\Python\Python311\Lib\site-packages\cv2" main.py
        # 업데이트버젼
        ...
        self.setGeometry(20 + 960, 100, 900, 800)
        self.show()
    def my_title(self):
...
class FirstTab(QWidget):
    ...
    def initUI(self):
        ...
        # 던전 종류
        self.dun_group_2 = QGroupBox('수련동굴')
    ...
    def onActivated_dunjeon_1_add(self):
        ...
        elif onDunjeon_1 == '특수던전 선택' or onDunjeon_1 == 'none':
            pyautogui.alert(button='넵', text='던전 및 층수를 선택해 주시지예', title='아 진짜 뭐합니꺼')
        elif onCharacter != 0 and (onDunjeon_1 != '특수던전 선택' or onDunjeon_1 != 'none'):
            print('char_', char_)
            print('dun_', dun_)
                        ...
                        if game_title == True:
                            ...
                            if is_game == False:
                                ...
                                if result_game_out_check == True:
                                    result_game_out_check_after = game_out_check_after(v_.now_cla)

                                    if result_game_out_check_after == True:
